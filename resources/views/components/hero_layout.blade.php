<div class="relative min-h-screen w-full px-6 py-6 overflow-hidden #flex items-center justify-center hero_main" >
    ...
    <div class="w-max">
        ...
        <div class="md:mt-12 mt-7">
            <a href="{{ route('rooms') }}" class="w-40 px-5 py-3 md:w-50 md:px-10 bg-white text-black rounded-3xl manrope text-sm flex items-center justify-center">Book a room <span><img src={{ Vite::asset('resources/css/images/right_arrow.gif') }} alt="Arrow" class="ml-2 w-5 h-5"></span></a>
        </div>
