<div class="flex items-center justify-between w-full golden_background">

    <div class="w-1 h-1 gradient_1 border-2 border-black"></div>
    <div class="w-1 h-1 gradient_1 border-2 border-black"></div>
    <div class="w-1 h-1 gradient_1"></div>
    <div class="w-1 h-1 gradient_1  border-2 border-black"></div>
    <div class="w-1 h-1 gradient_1"></div>
    <div class="w-1 h-1 gradient_1"></div>
...
<div class="relative min-h-screen w-full px-6 py-6 section_page" >
    <h2 class="cinzel md:text-5xl text-2xl md:mt-10 mt-2">Services</h2>
    <div class="md:mt-10 mt-4 gradient_1 w-full md:px-6 px-3 md:py-6 py-3 gap-5 rounded-md lg:h-max md:h-190 flex flex-wrap items-start justify-between">
        <div class="rounded-md md:px-6 px-0 md:py-6 py-0 md:w-full lg:w-100 w-0 lg:h-100 md:h-65 h-0 overflow-hidden services_section">
            <h2 class="cinzel golden_color text-3xl"><i>Designed Just for You</i></h2>
            <p class="text-sm manrope text-gray-300 leading-7 lg:mt-50 md:mt-20">
                At Royal Guest Palace, we believe every guest deserves an extraordinary experience.
                Whether you are visiting for business or leisure, we are dedicated to making every moment of your stay truly exceptional.
            </p>
        </div>
        <div class="rounded-md lg:w-180 md:w-full h-max lg:mt-0">
            <div>
                <h1 class="cinzel mb:text-2xl text-lg mb-3 text-left w-full">What we Offer</h1>
            </div>
