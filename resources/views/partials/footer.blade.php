<div class="relative h-70 w-full footer_section flex items-center justify-between">
    <div class="clipped_path_1 h-70 md:w-170 w-full gradient_1 px-6 py-6 flex flex-col items-start justify-start gap-5">
        <h2 class="text-gray-300 md:text-5xl text-2xl cinzel md:mb-3 mb-1">Royal Hotel</h2>
    ...
    {{--  <div class="w-50 h-70 bg-white"></div>  --}}
    <div class="hidden clipped_path_2 h-70 w-170 gradient_1 px-6 py-6 lg:flex lg:ml-0 items-center justify-center">
        <div>
            <p class="leading-7 manrope">
